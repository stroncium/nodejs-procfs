...
module.exports = {
	...
	processStatus: asserter(Joi.object().keys({
		...
		umask: Joi.number().integer().required(),
		...
		state: Joi.string().required(),
		speculationStoreBypass: Joi.string().required(),
		...
		rssShmem: Joi.number().integer().required(),
		rssFile: Joi.number().integer().required(),
		rssAnon: Joi.number().integer().required(),
		pid: Joi.number().integer().required(),
		parent: Joi.number().integer().required(),
		numaGroupId: Joi.number().integer().required(),
		noNewPrivs: Joi.boolean().required(),
		name: Joi.string().required(),
		...
		coreDumping: Joi.boolean().required(),
	...
	meminfo: asserter(Joi.object().keys({
		...
		shmemPmdMapped: Joi.number().integer().required(),
		shmemHugePages: Joi.number().integer().required(),
		...
		kernelReclaimable: Joi.number().integer().required(),
