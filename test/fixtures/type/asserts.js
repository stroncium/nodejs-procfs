...
module.exports = {
	...
	processStatus: asserter(Joi.object().keys({
		...
		signalsIgnored: Joi.string().allow('').required(),
		signalsCaught: Joi.string().allow('').required(),
		signalsBlocked: Joi.string().allow('').required(),
		...
		capabilityPermitted: Joi.string().allow('').required(),
		capabilityInheritable: Joi.string().allow('').required(),
		capabilityEffective: Joi.string().allow('').required(),
		capabilityBounding: Joi.string().allow('').required(),
		capabilityAmbient: Joi.string().allow('').required(),
	}).required()),
