...
module.exports = src => {
	...
	switch (ps[0]) {
		...
		case 'anon_inode':
			anonInodeType = ps[1];
			/* istanbul ignore else */ // According to `man`, brackets aren't always there, however I didn't manage to find an example
		...
		/* istanbul ignore next */ // Didn't find example, forward compatibility
		default:
