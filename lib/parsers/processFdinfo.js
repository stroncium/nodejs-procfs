...
const fanotifyMarkMap = new Map([
	['sdev', (obj, v) => obj.deviceId = parseInt(v, 16)],
...
const fdinfoMap = new Map([
	['pos', (obj, v) => obj.pos = parseInt(v)],
	['mnt_id', (obj, v) => obj.mntId = parseInt(v)],
	['flags', (obj, v) => obj.flags = parseInt(v, 8)],
	['eventfd-count', (obj, v) => {
		obj.type = 'eventfd';
		obj.eventfdCounter = parseInt(v, 16);
	}],
	['tfd', (obj, v) => {
		obj.type = 'epoll';
		...
		obj.epollCounters.push({
			fd: parseInt(ps[0]),
			eventMask: parseInt(ps[2], 16),
			data: ps.slice(4).join(' '), // TODO format doesn't match man page, investigate
		});
	}],
	['sigmask', (obj, v) => {
		obj.type = 'signal';
